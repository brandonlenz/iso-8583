...
public class SampleIso8583MessageDefinition extends Iso8583MessageDefinition {
    ...
    private static List<FieldDefinition> getSampleIso8583FieldDefinitions() {
        ...
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.PRIMARY_ACCOUNT_NUMBER,                       15, 19, NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        ...
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ACQUIRING_INSTITUTION_IDENTIFICATION_CODE,    11,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.FORWARDING_INSTITUTION_IDENTIFICATION_CODE,   11,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.PRIMARY_ACCOUNT_NUMBER_EXTENDED,              28,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC_SPECIAL,        new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.TRACK_2_DATA,                                 37,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC_SPECIAL,        new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.TRACK_3_DATA,                                 104,    NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        ...
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ADDITIONAL_RESPONSE_DATA,                     25,     ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.TRACK_1_DATA,                                 76,     ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ADDITIONAL_DATA_ISO,                          999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ADDITIONAL_DATA_NATIONAL,                     999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ADDITIONAL_DATA_PRIVATE,                      999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        ...
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ADDITIONAL_AMOUNTS,                           120,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC,           new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ICC_DATA,                                     999,    BYTE_FIELD_ENCODING,            ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_ISO,                                 999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_NATIONAL,                            999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_NATIONAL,                            999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_NATIONAL,                            999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_NATIONAL,                            999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_PRIVATE,                             999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_PRIVATE,                             999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_PRIVATE,                             999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        ...
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.SETTLEMENT_INSTITUTION_IDENTIFICATION_CODE,   11,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RECEIVING_INSTITUTION_IDENTIFICATION_CODE,    11,     NUMERIC_FIELD_ENCODING,         ContentType.NUMERIC,                new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.FILE_NAME,                                    17,     ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ACCOUNT_IDENTIFICATION_1,                     28,     ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.ACCOUNT_IDENTIFICATION_2,                     28,     ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.TRANSACTION_DESCRIPTION,                      100,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(2, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_ISO,                                 999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_ISO,                                 999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_ISO,                                 999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
        fieldDefinitions.add(new VliFieldDefinition(    FieldName.RESERVED_ISO,                                 999,    ALPHANUMERIC_FIELD_ENCODING,    ContentType.ALPHANUMERIC_SPECIAL,   new VliDefinition(3, Encoding.HEXADECIMAL_ASCII, ContentType.BYTES)));
