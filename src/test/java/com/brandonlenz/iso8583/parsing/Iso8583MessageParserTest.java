...
//        assertEquals("161234567890123456", parsedMessage.build(2).getData());
//        assertEquals("000000010000", parsedMessage.build(4).getData());
//        assertEquals("052", parsedMessage.build(23).getData());
//        assertEquals("01599F260801020304050607089F270180", parsedMessage.build(55).getData());
//    }
//}